...
public class DecrypterUtil {
    ...
    public static byte[] encrypt(String plainText, String encryptionKey) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, key,new IvParameterSpec(Constants.INITIALIZATION_VECTOR.getBytes("UTF-8")));
    ...
    public static String decrypt(String encryptedText) throws Exception{
        ...
        cipher.init(Cipher.DECRYPT_MODE, key,new IvParameterSpec(Constants.INITIALIZATION_VECTOR.getBytes("UTF-8")));
